...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="navbar fixed navbar-new-comp">
            ...
            <div className="search-container">
              <div className="relative" ref={searchContainerRef}>
                <form className="search-box row-center-center">
                  <span className="search-icon inline-box">
                    {svgIcons.search}
                  </span>
                  <input
                    type="search"
                ...
                <div className="wallet-address-container relative row-between-center">
                  <button className="btn-white font-bold">
                    <Link href="/items/owned">
                      {
                        CompressAddress(String(wallet?.address.toB256()))
                          .compressedAddress
                      }
                    </Link>
                  </button>
                  ...
                  <div className="chain-name-box font-light">
                    {wallet.provider.url ==
                      blockchain["fuel_testnet"].publicRpc && (
                      <span
                        style={{
                          fontSize: "var(--fs-sm)",
      ...
      <div className={`mobile-menu ${isOpen ? "open" : ""}`}>
        ...
        <div className="mobile-menu-content">
          {wallet?.address && (
            <>
              <div className="addAndCopy">
                <button className="btn-white font-bold">
                  <Link href="/items/owned" onClick={() => setIsOpen(!isOpen)}>
                    {
                      CompressAddress(String(wallet?.address.toB256()))
                        .compressedAddress
                    }
                ...
                <button
                  ...
                  onClick={() => {
                    navigator.clipboard &&
                      ...
                      navigator.clipboard
                        .writeText(wallet?.address.toB256())
                        .then(() => {
                          toast.success("Wallet Address Copied Successfully!");
                        })
                        .catch((err) => {
              ...
              <div className="chain-name-box font-light">
                {wallet.provider.url ==
                  ...
                  <span
                    ...
                    className="uppercase rnd-border"
                  >
                    Testnet
                  </span>
                )}
