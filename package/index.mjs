...
import { Address as Address2 } from "fuels";

// src/utils/blockchain.ts
import axios from "axios";
import { Address, getMintedAssetId, isB256, Provider } from "fuels";
...
var NonFungibleCreator = class extends Contract {
...
var _NonFungibleCreatorFactory = class _NonFungibleCreatorFactory extends ContractFactory {
...
import { Contract as Contract2, Interface as Interface2 } from "fuels";
var abi2 = {
  "programType": "contract",
  "specVersion": "1",
  "encodingVersion": "1",
...
var SemiFungibleCreator = class extends Contract2 {
  constructor(id, accountOrProvider) {
...
import { ContractFactory as ContractFactory2, decompressBytecode as decompressBytecode2 } from "fuels";
var bytecode2 = decompressBytecode2(
...
var _SemiFungibleCreatorFactory = class _SemiFungibleCreatorFactory extends ContractFactory2 {
  constructor(accountOrProvider) {
...
var fetchAllNftOfContract = (network, contractAddress, nftStandard, assetIds) => __async(void 0, null, function* () {
  ...
  const provider = yield Provider.create(publicRpcs[network]);
...
import { Provider as Provider2 } from "fuels";

// src/contracts/marketplace/typegen/nft-marketplace.ts
import { Contract as Contract3, Interface as Interface3 } from "fuels";
var abi3 = {
  "programType": "contract",
  "specVersion": "1",
  "encodingVersion": "1",
...
var NftMarketplace = class extends Contract3 {
  constructor(id, accountOrProvider) {
...
import { ContractFactory as ContractFactory3, decompressBytecode as decompressBytecode3 } from "fuels";
var bytecode3 = decompressBytecode3(
...
var _NftMarketplaceFactory = class _NftMarketplaceFactory extends ContractFactory3 {
  constructor(accountOrProvider) {
  ...
  execute() {
    return __async(this, null, function* () {
      ...
      try {
        ...
        const transactionAwaited = yield this.contract.functions.buy_nft(bn(this.listingId), bn(this.quantity)).callParams({
    ...
    return __async(this, null, function* () {
      ...
      try {
        ...
        const transactionAwaited = yield this.contract.functions.list_nft(
          ...
          forward: [bn3(this.amount), this.assetId]
        }).call();
        const finalTransaction = yield transactionAwaited.waitForResult();
