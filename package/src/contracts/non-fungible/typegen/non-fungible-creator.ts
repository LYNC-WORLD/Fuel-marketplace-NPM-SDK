...
export type NonFungibleCreatorConfigurables = Partial<{
...
export class NonFungibleCreatorInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class NonFungibleCreator extends Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: NonFungibleCreatorInterface;
  declare functions: {
    get_ctr: InvokeFunction<[], BN>;
    mint: InvokeFunction<[recipient: IdentityInput, uri: StdString], void>;
    ...
    token_uri: InvokeFunction<[asset_id: AssetIdInput], StdString>;
  };
