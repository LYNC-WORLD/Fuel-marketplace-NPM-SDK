...
declare class ListTokenService extends MarketplaceServices {
    ...
    constructor(contract: NftMarketplace);
    setProperties(assetId: `0x${string}`, contractId: `0x${string}`, subId: `0x${string}`, price: number, amount: number, tokenStandard: NFTStandardInput): this;
    execute(): Promise<unknown>;
}
...
declare class ModifyListingService extends MarketplaceServices {
    ...
    constructor(contract: NftMarketplace);
    setProperties(assetId: `0x${string}`, listingId: `0x${string}`, newPrice: number, quantityToAdd: number): this;
    execute(): Promise<unknown>;
}
